...
async function getPoolsByCityId(req: Request, res: Response) {
  ...
  Ponds.find({ cityId: req.params.cityId, ...NOT_ARCHIVED }, { _id: 1 }, function (err, docs: any) {
